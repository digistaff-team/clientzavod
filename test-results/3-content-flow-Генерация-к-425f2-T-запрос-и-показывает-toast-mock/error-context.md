...
- Name: 3-content-flow.spec.js >> Генерация контента >> нажатие "Сгенерировать сейчас" делает POST запрос и показывает toast
- Location: tests\e2e\specs\3-content-flow.spec.js:33:3
...
Call log:
  - navigating to "http://localhost:3015/", waiting until "load"
