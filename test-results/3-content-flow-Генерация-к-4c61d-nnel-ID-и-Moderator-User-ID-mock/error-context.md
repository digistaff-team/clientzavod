...
- Name: 3-content-flow.spec.js >> Генерация контента >> Telegram панель содержит Channel ID и Moderator User ID
- Location: tests\e2e\specs\3-content-flow.spec.js:17:3
