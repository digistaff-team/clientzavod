...
- Name: 3-content-flow.spec.js >> Генерация контента >> Moderator User ID заполнен chatId из loadContentSettings
- Location: tests\e2e\specs\3-content-flow.spec.js:22:3
